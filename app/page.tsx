        ...
        <div className="hero-copy">
          ...
          <div className="intro">
            ...
            <p>
              ...
              economics. i firmly believe my research should be scientific and inform
              society towards its growth, and would like my work to meaningfully
              motivate in this direction.
            </p>
          </div>
